        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-1 space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-1">Telefone</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-600">contato@kadu.tec.br</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-1">Localização</h3>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-blue-500 p-2 rounded-full text-white hover:bg-blue-600 transition-colors">
